...
namespace PokemonUltimate.Localization.Extensions
{
    ...
    public static class SideConditionDataExtensions
    {
        ...
        public static string GetDisplayName(this SideConditionData sideCondition, ILocalizationProvider localizationProvider = null)
        {
        ...
        public static string GetDescription(this SideConditionData sideCondition, ILocalizationProvider localizationProvider = null)
        {
            if (sideCondition == null)
                return string.Empty;
