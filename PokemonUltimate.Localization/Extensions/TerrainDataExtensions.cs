...
namespace PokemonUltimate.Localization.Extensions
{
    ...
    public static class TerrainDataExtensions
    {
        ...
        public static string GetDisplayName(this TerrainData terrain, ILocalizationProvider localizationProvider = null)
        {
            if (terrain == null)
                return string.Empty;
        ...
        public static string GetDescription(this TerrainData terrain, ILocalizationProvider localizationProvider = null)
        {
            if (terrain == null)
                return string.Empty;
