...
namespace PokemonUltimate.Localization.Extensions
{
    ...
    public static class HazardDataExtensions
    {
        ...
        public static string GetDisplayName(this HazardData hazard, ILocalizationProvider localizationProvider = null)
        {
            if (hazard == null)
                return string.Empty;
        ...
        public static string GetDescription(this HazardData hazard, ILocalizationProvider localizationProvider = null)
        {
            if (hazard == null)
                return string.Empty;
