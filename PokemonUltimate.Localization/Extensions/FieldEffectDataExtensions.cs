...
namespace PokemonUltimate.Localization.Extensions
{
    ...
    public static class FieldEffectDataExtensions
    {
        ...
        public static string GetDisplayName(this FieldEffectData fieldEffect, ILocalizationProvider localizationProvider = null)
        {
            if (fieldEffect == null)
                return string.Empty;
        ...
        public static string GetDescription(this FieldEffectData fieldEffect, ILocalizationProvider localizationProvider = null)
        {
            if (fieldEffect == null)
                return string.Empty;
