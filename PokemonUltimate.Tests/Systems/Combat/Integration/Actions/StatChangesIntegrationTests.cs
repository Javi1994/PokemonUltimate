...
namespace PokemonUltimate.Tests.Systems.Combat.Integration.Actions
{
    ...
    public class StatChangesIntegrationTests
    {
        ...
        public void StatChangeAction_SpeedStage_ThenTurnOrderResolver_AffectsOrder()
        {
            ...
            float pikachuSpeedBefore = _resolver.GetEffectiveSpeed(pikachuSlot, _field);
            float charmanderSpeedBefore = _resolver.GetEffectiveSpeed(charmanderSlot, _field);
            ...
            float pikachuSpeedAfter = _resolver.GetEffectiveSpeed(pikachuSlot, _field);
            float charmanderSpeedAfter = _resolver.GetEffectiveSpeed(charmanderSlot, _field);
        ...
        public void StatChangeAction_SpeedStage_ThenCombatEngine_AffectsTurnOrder()
        {
            ...
            var sortedBefore = resolver.SortActions(actionsBefore, engine.Field);
            ...
            var sortedAfter = resolver.SortActions(actionsAfter, engine.Field);
            ...
            float playerSpeedAfter = resolver.GetEffectiveSpeed(engine.Field.PlayerSide.Slots[0], engine.Field);
            float enemySpeedAfter = resolver.GetEffectiveSpeed(engine.Field.EnemySide.Slots[0], engine.Field);
