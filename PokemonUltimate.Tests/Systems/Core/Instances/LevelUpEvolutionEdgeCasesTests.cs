    ...
    public class LevelUpEvolutionEdgeCasesTests
    {
        ...
        public void SetUp()
        {
            ...
            _evolvedSpecies = new PokemonSpeciesData
            {
                ...
                Evolutions = new List<PokemonUltimate.Core.Evolution.Evolution>
                {
                    new PokemonUltimate.Core.Evolution.Evolution
                    {
        ...
        public void Item_Evolution_Works_With_Correct_Item()
        {
            ...
            var pikachu = new PokemonSpeciesData
            {
                ...
                Evolutions = new List<PokemonUltimate.Core.Evolution.Evolution>
                {
                    ...
                    {
                        Target = raichu,
                        Conditions = new List<PokemonUltimate.Core.Evolution.IEvolutionCondition> { new ItemCondition("Thunder Stone") }
                    }
                }
            };
        ...
        public void Trade_Evolution_Works()
        {
            ...
            var haunter = new PokemonSpeciesData
            {
                ...
                Evolutions = new List<PokemonUltimate.Core.Evolution.Evolution>
                {
                    ...
                    {
                        Target = gengar,
                        Conditions = new List<PokemonUltimate.Core.Evolution.IEvolutionCondition> { new TradeCondition() }
                    }
                }
            };
        ...
        public void Friendship_Evolution_Works_When_Happy()
        {
            ...
            var eevee = new PokemonSpeciesData
            {
                ...
                Evolutions = new List<PokemonUltimate.Core.Evolution.Evolution>
                {
                    ...
                    {
                        Target = espeon,
                        Conditions = new List<PokemonUltimate.Core.Evolution.IEvolutionCondition> { new FriendshipCondition(220) }
                    }
                }
            };
        ...
        public void KnowsMove_Evolution_Works()
        {
            ...
            var piloswine = new PokemonSpeciesData
            {
                ...
                Evolutions = new List<PokemonUltimate.Core.Evolution.Evolution>
                {
                    ...
                    {
                        Target = mamoswine,
                        Conditions = new List<PokemonUltimate.Core.Evolution.IEvolutionCondition> { new KnowsMoveCondition(ancientPower) }
                    }
                }
            };
