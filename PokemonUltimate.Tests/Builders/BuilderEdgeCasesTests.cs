...
namespace PokemonUltimate.Tests.Builders
{
    ...
    public class BuilderEdgeCasesTests
    {
        ...
        {
            var pokemon = Pokemon.Define("TestMon", 0)
                .Type(PokemonType.Normal)
                .Stats(100, 100, 100, 100, 100, 100)
                .Build();
        ...
        public void PokemonBuilder_NegativePokedexNumber_Allowed()
        {
            ...
            var pokemon = Pokemon.Define("TestMon", -1)
                .Type(PokemonType.Normal)
                .Stats(100, 100, 100, 100, 100, 100)
                .Build();
        ...
        {
            var pokemon = Pokemon.Define("ZeroStatMon", 1)
                .Type(PokemonType.Normal)
                .Stats(0, 0, 0, 0, 0, 0)
                .Build();
        ...
        {
            var pokemon = Pokemon.Define("SuperMon", 1)
                .Type(PokemonType.Normal)
        ...
        public void PokemonBuilder_SameTypeTwice_Allowed()
        {
            ...
            var pokemon = Pokemon.Define("FireFire", 1)
        ...
        {
            var allMale = Pokemon.Define("AllMale", 1)
                .Type(PokemonType.Normal)
                .Stats(100, 100, 100, 100, 100, 100)
                .GenderRatio(100.0f)
                .Build();
            ...
            var allFemale = Pokemon.Define("AllFemale", 2)
                .Type(PokemonType.Normal)
                .Stats(100, 100, 100, 100, 100, 100)
                .GenderRatio(0.0f)
                .Build();
            ...
            var genderless = Pokemon.Define("Genderless", 3)
                .Type(PokemonType.Normal)
                .Stats(100, 100, 100, 100, 100, 100)
                .Genderless()
                .Build();
        ...
        {
            var pokemon = Pokemon.Define("NoEvo", 1)
                .Type(PokemonType.Normal)
                .Stats(100, 100, 100, 100, 100, 100)
                .Build();
        ...
        {
            var pokemon = Pokemon.Define("NoMoves", 1)
                .Type(PokemonType.Normal)
                .Stats(100, 100, 100, 100, 100, 100)
                .Build();
        ...
        {
            var target = Pokemon.Define("Evo", 2)
                .Type(PokemonType.Normal)
                .Stats(100, 100, 100, 100, 100, 100)
                .Build();

            var pokemon = Pokemon.Define("Base", 1)
                .Type(PokemonType.Normal)
        ...
        {
            var pokemon = Pokemon.Define("Test", 1)
                .Type(PokemonType.Normal)
                .Stats(100, 100, 100, 100, 100, 100)
