...
namespace PokemonUltimate.Tests.Models
{
    ...
    public class LearnsetEdgeCasesTests
    {
        ...
        public void Setup()
        {
            ...
            _pokemonWithManyMoves = Pokemon.Define("ManyMovesPokemon", 800)
            ...
            _pokemonWithNoMoves = Pokemon.Define("NoMovesPokemon", 801)
                .Type(PokemonType.Normal)
                .Stats(100, 100, 100, 100, 100, 100)
                .Build();

            // Pokemon with same move learned at multiple levels (edge case)
            _pokemonWithDuplicateMoves = Pokemon.Define("DuplicateMovesPokemon", 802)
            ...
            _pokemonWithSameLevelMoves = Pokemon.Define("SameLevelMovesPokemon", 803)
