...
namespace PokemonUltimate.Tests.Combat.Integration
{
    ...
    internal class MockBattleViewForIntegration : IBattleView
    {
        ...
        public Task<MoveInstance> SelectMove(System.Collections.Generic.IReadOnlyList<MoveInstance> moves)
        {
            return Task.FromResult(MoveToReturn ?? moves?.FirstOrDefault());
        }

        public Task<BattleSlot> SelectTarget(System.Collections.Generic.IReadOnlyList<BattleSlot> validTargets)
        {
            return Task.FromResult(TargetToReturn ?? validTargets?.FirstOrDefault());
        }

        public Task<PokemonInstance> SelectSwitch(System.Collections.Generic.IReadOnlyList<PokemonInstance> availablePokemon)
        {
