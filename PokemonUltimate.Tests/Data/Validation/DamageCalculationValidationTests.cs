...
{
    /// <summary>
    /// Validation tests that compare our damage calculation against
    ...
    /// </summary>
    [TestFixture]
    public class DamageCalculationValidationTests
    {
        ...
        public void Verify_BaseFormula_Level50_Power100_Attack100_Defense100()
        {
            ...
            var attacker = Core.Factories.Pokemon.Create(PokemonCatalog.Pikachu, 50)
                .WithStats(hp: 150, atk: 100, def: 80, spAtk: 100, spDef: 80, speed: 100)
                .WithNeutralNature()
                .Build();

            var defender = Core.Factories.Pokemon.Create(PokemonCatalog.Eevee, 50)
        ...
        {
            var attackerLv50 = Core.Factories.Pokemon.Create(PokemonCatalog.Pikachu, 50)
                .WithStats(hp: 150, atk: 100, def: 80, spAtk: 100, spDef: 80, speed: 100)
                .WithNeutralNature()
                .Build();

            var attackerLv100 = Core.Factories.Pokemon.Create(PokemonCatalog.Pikachu, 100)
                .WithStats(hp: 150, atk: 100, def: 80, spAtk: 100, spDef: 80, speed: 100)
                .WithNeutralNature()
                .Build();
        ...
        {
            var pikachu = Core.Factories.Pokemon.Create(PokemonCatalog.Pikachu, 50)
                .WithStats(hp: 135, atk: 90, def: 70, spAtk: 100, spDef: 80, speed: 120)
                .WithNeutralNature()
                .Build();

            var eevee = Core.Factories.Pokemon.Create(PokemonCatalog.Eevee, 50)
        ...
        public void Verify_SuperEffective_Electric_vs_Water_Is2x()
        {
            ...
            var squirtle = Core.Factories.Pokemon.Create(PokemonCatalog.Squirtle, 50)
        ...
        {
            var bulbasaur = Core.Factories.Pokemon.Create(PokemonCatalog.Bulbasaur, 50)
        ...
        {
            var charmander = Core.Factories.Pokemon.Create(PokemonCatalog.Charmander, 50)
        ...
        {
            var snorlax = Core.Factories.Pokemon.Create(PokemonCatalog.Snorlax, 50)
                .WithStats(hp: 250, atk: 130, def: 85, spAtk: 85, spDef: 130, speed: 50)
                .Build();

            var charizard = Core.Factories.Pokemon.Create(PokemonCatalog.Charizard, 50)
