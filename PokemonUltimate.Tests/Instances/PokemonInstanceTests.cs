...
namespace PokemonUltimate.Tests.Instances
{
    ...
    public class PokemonInstanceTests
    {
        ...
        private Core.Evolution.Evolution _levelEvolution;
        private Core.Evolution.Evolution _friendshipEvolution;
        ...
        private void SetupEvolutionData()
        {
            ...
            _levelEvolution = new Core.Evolution.Evolution
            {
            ...
            _friendshipEvolution = new Core.Evolution.Evolution
            {
                Target = _evolvedSpecies,
                Conditions = new List<Core.Evolution.IEvolutionCondition>
                {
        ...
        {
            SetupEvolutionData();
            _testSpecies.Evolutions = new List<Core.Evolution.Evolution> { _levelEvolution };
            var instance = CreateTestInstance(level: 10);
        ...
        {
            SetupEvolutionData();
            _testSpecies.Evolutions = new List<Core.Evolution.Evolution> { _friendshipEvolution };
            var instance = CreateTestInstance(level: 10);
