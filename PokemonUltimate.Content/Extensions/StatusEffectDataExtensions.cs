...
namespace PokemonUltimate.Content.Extensions
{
    ...
    public static class StatusEffectDataExtensions
    {
        ...
        public static string GetLocalizedName(this StatusEffectData statusEffect, ILocalizationProvider localizationProvider = null)
        {
        ...
        public static string GetLocalizedDescription(this StatusEffectData statusEffect, ILocalizationProvider localizationProvider = null)
        {
            if (statusEffect == null)
                return string.Empty;
