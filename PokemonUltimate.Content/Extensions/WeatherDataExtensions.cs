...
namespace PokemonUltimate.Content.Extensions
{
    ...
    public static class WeatherDataExtensions
    {
        ...
        public static string GetLocalizedName(this WeatherData weather, ILocalizationProvider localizationProvider = null)
        {
            if (weather == null)
                return string.Empty;
        ...
        public static string GetLocalizedDescription(this WeatherData weather, ILocalizationProvider localizationProvider = null)
        {
            if (weather == null)
                return string.Empty;
