...
namespace PokemonUltimate.Core.Infrastructure.Builders
{
    ...
    public class PokemonBuilder
    {
        ...
        private readonly List<Domain.Evolution.Evolution> _evolutions = new List<Domain.Evolution.Evolution>();
        ...
        /// </summary>
        public PokemonBuilder GrowthRate(GrowthRate growthRate)
        {
        ...
        /// </summary>
        public PokemonBuilder Color(PokemonColor color)
        {
        ...
        /// </summary>
        public PokemonBuilder Shape(PokemonShape shape)
        {
        ...
        /// </summary>
        public PokemonBuilder Habitat(PokemonHabitat habitat)
        {
