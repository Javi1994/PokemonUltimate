...
using PokemonUltimate.Core.Domain.Evolution.Conditions;
...
namespace PokemonUltimate.Core.Domain.Instances.Pokemon
{
    ...
    public partial class PokemonInstance
    {
        ...
        /// </summary>
        public Domain.Evolution.Evolution GetAvailableEvolution()
        {
        ...
        /// </summary>
        public Domain.Evolution.Evolution GetEvolutionWithItem(string itemName)
        {
        ...
        /// Returns null if no matching evolution exists.
        /// </summary>
        public Domain.Evolution.Evolution GetEvolutionByTrade()
        {
            if (Species.Evolutions == null || Species.Evolutions.Count == 0)
                return null;
        ...
        /// </summary>
        public List<Domain.Evolution.Evolution> GetAvailableEvolutions()
        {
            if (Species.Evolutions == null || Species.Evolutions.Count == 0)
                return new List<Domain.Evolution.Evolution>();
