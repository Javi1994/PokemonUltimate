...
namespace PokemonUltimate.Core.Domain.Instances.Pokemon
{
    ...
    public partial class PokemonInstance
    {
        ...
        public bool CanLevelUp()
        {
            ...
            return CurrentExp >= StatCalculatorService.GetExpForLevel(Level + 1);
        }
        ...
        public int GetExpForNextLevel()
        {
            ...
            return StatCalculatorService.GetExpForLevel(Level + 1);
        }
        ...
        public int GetExpToNextLevel()
        {
            ...
            int needed = StatCalculatorService.GetExpForLevel(Level + 1);
        ...
        public bool LevelUp()
        {
            ...
            CurrentExp = Math.Max(CurrentExp, StatCalculatorService.GetExpForLevel(Level + 1));
            LevelUpInternal();
            return true;
        }
        ...
        private void RecalculateStats()
        {
            ...
            int maxHP = StatCalculatorService.CalculateHP(Species.BaseStats.HP, Level);
            int attack = StatCalculatorService.CalculateStat(Species.BaseStats.Attack, Level, Nature, Stat.Attack);
            int defense = StatCalculatorService.CalculateStat(Species.BaseStats.Defense, Level, Nature, Stat.Defense);
            int spAttack = StatCalculatorService.CalculateStat(Species.BaseStats.SpAttack, Level, Nature, Stat.SpAttack);
            int spDefense = StatCalculatorService.CalculateStat(Species.BaseStats.SpDefense, Level, Nature, Stat.SpDefense);
            int speed = StatCalculatorService.CalculateStat(Species.BaseStats.Speed, Level, Nature, Stat.Speed);
