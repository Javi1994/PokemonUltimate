...
namespace PokemonUltimate.Core.Instances
{
    ...
    public partial class PokemonInstance
    {
        ...
        {
            var property = typeof(PokemonInstance).GetProperty(nameof(MaxHP), BindingFlags.Public | BindingFlags.Instance);
        ...
        {
            var property = typeof(PokemonInstance).GetProperty(nameof(Attack), BindingFlags.Public | BindingFlags.Instance);
            var setter = property?.GetSetMethod(nonPublic: true);
            setter?.Invoke(this, new object[] { value });
        }
        ...
        {
            var property = typeof(PokemonInstance).GetProperty(nameof(Defense), BindingFlags.Public | BindingFlags.Instance);
            var setter = property?.GetSetMethod(nonPublic: true);
            setter?.Invoke(this, new object[] { value });
        }
        ...
        {
            var property = typeof(PokemonInstance).GetProperty(nameof(SpAttack), BindingFlags.Public | BindingFlags.Instance);
            var setter = property?.GetSetMethod(nonPublic: true);
            setter?.Invoke(this, new object[] { value });
        }
        ...
        {
            var property = typeof(PokemonInstance).GetProperty(nameof(SpDefense), BindingFlags.Public | BindingFlags.Instance);
            var setter = property?.GetSetMethod(nonPublic: true);
            setter?.Invoke(this, new object[] { value });
        }
        ...
        {
            var property = typeof(PokemonInstance).GetProperty(nameof(Speed), BindingFlags.Public | BindingFlags.Instance);
            var setter = property?.GetSetMethod(nonPublic: true);
            setter?.Invoke(this, new object[] { value });
        }
    }
