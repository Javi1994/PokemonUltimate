...
namespace PokemonUltimate.Core.Services
{
    ...
    /// </remarks>
    public class StatStageService : IStatStageService
    {
        private static readonly IStatStageService _defaultInstance = new StatStageService();
        public static IStatStageService Default => _defaultInstance;
