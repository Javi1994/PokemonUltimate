...
namespace PokemonUltimate.Core.Services
{
    ...
    public class TypeEffectivenessService : ITypeEffectivenessService
    {
        ...
        private static readonly ITypeEffectivenessService _defaultInstance = new TypeEffectivenessService();
        ...
        /// </summary>
        public static ITypeEffectivenessService Default => _defaultInstance;
        ...
        /// </summary>
        float ITypeEffectivenessService.GetEffectiveness(PokemonType attackType, PokemonType defenderType)
        {
        ...
        /// </summary>
        float ITypeEffectivenessService.GetEffectiveness(PokemonType attackType, PokemonType primaryType, PokemonType? secondaryType)
        {
            float primaryMult = ((ITypeEffectivenessService)this).GetEffectiveness(attackType, primaryType);

            if (secondaryType.HasValue)
            {
                float secondaryMult = ((ITypeEffectivenessService)this).GetEffectiveness(attackType, secondaryType.Value);
        ...
        /// </summary>
        bool ITypeEffectivenessService.IsSuperEffective(float effectiveness)
        {
        ...
        /// </summary>
        bool ITypeEffectivenessService.IsNotVeryEffective(float effectiveness)
        {
        ...
        /// </summary>
        bool ITypeEffectivenessService.IsImmune(float effectiveness)
        {
        ...
        /// </summary>
        string ITypeEffectivenessService.GetEffectivenessDescription(float effectiveness)
        {
        ...
        /// </summary>
        float ITypeEffectivenessService.GetSTABMultiplier(PokemonType moveType, PokemonType primaryType, PokemonType? secondaryType)
        {
        ...
        /// </summary>
        List<PokemonType> ITypeEffectivenessService.GetSuperEffectiveAgainst(PokemonType attackType)
        {
        ...
        /// </summary>
        List<PokemonType> ITypeEffectivenessService.GetResistedBy(PokemonType attackType)
        {
            var result = new List<PokemonType>();
            if (_typeChart.TryGetValue(attackType, out var defenderChart))
            {
        ...
        /// </summary>
        List<PokemonType> ITypeEffectivenessService.GetImmuneTypes(PokemonType attackType)
        {
            var result = new List<PokemonType>();
            if (_typeChart.TryGetValue(attackType, out var defenderChart))
            {
        ...
        {
            return ((ITypeEffectivenessService)_defaultInstance).GetEffectiveness(attackType, defenderType);
        }
        ...
        {
            return ((ITypeEffectivenessService)_defaultInstance).GetEffectiveness(attackType, primaryType, secondaryType);
        }
        ...
        {
            return ((ITypeEffectivenessService)_defaultInstance).IsSuperEffective(effectiveness);
        }
        ...
        {
            return ((ITypeEffectivenessService)_defaultInstance).IsNotVeryEffective(effectiveness);
        }
        ...
        {
            return ((ITypeEffectivenessService)_defaultInstance).IsImmune(effectiveness);
        }
        ...
        {
            return ((ITypeEffectivenessService)_defaultInstance).GetEffectivenessDescription(effectiveness);
        }
        ...
        {
            return ((ITypeEffectivenessService)_defaultInstance).GetSTABMultiplier(moveType, primaryType, secondaryType);
        }
        ...
        {
            return ((ITypeEffectivenessService)_defaultInstance).GetSuperEffectiveAgainst(attackType);
        }
        ...
        {
            return ((ITypeEffectivenessService)_defaultInstance).GetResistedBy(attackType);
        }
        ...
        {
            return ((ITypeEffectivenessService)_defaultInstance).GetImmuneTypes(attackType);
        }
