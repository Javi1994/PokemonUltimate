...
namespace PokemonUltimate.Core.Services
{
    /// <summary>
    ...
    /// </remarks>
    public class StatCalculatorService : IStatCalculatorService
    {
        private static readonly IStatCalculatorService _defaultInstance = new StatCalculatorService();

        /// <summary>
        /// Gets the default instance for static method compatibility.
        /// </summary>
        public static IStatCalculatorService Default => _defaultInstance;
        ...
        /// </summary>
        int IStatCalculatorService.CalculateHP(int baseHP, int level)
        {
        ...
        /// </summary>
        int IStatCalculatorService.CalculateHP(int baseHP, int level, int iv, int ev)
        {
        ...
        /// </summary>
        int IStatCalculatorService.CalculateHP(int baseHP, int level, IVSet ivs, EVSet evs)
        {
            if (ivs == null)
        ...
        /// </summary>
        int IStatCalculatorService.CalculateStat(int baseStat, int level, Nature nature, Stat stat)
        {
        ...
        /// </summary>
        int IStatCalculatorService.CalculateStat(int baseStat, int level, Nature nature, Stat stat, int iv, int ev)
        {
        ...
        /// </summary>
        int IStatCalculatorService.CalculateStat(int baseStat, int level, Nature nature, Stat stat, IVSet ivs, EVSet evs)
        {
            if (ivs == null)
                throw new ArgumentNullException(nameof(ivs));
            if (evs == null)
        ...
        /// </summary>
        float IStatCalculatorService.GetStageMultiplier(int stage)
        {
        ...
        /// </summary>
        int IStatCalculatorService.GetEffectiveStat(int calculatedStat, int stage)
        {
            if (calculatedStat < 0)
                throw new ArgumentException(ErrorMessages.StatCannotBeNegative, nameof(calculatedStat));

            float multiplier = ((IStatCalculatorService)this).GetStageMultiplier(stage);
        ...
        /// </summary>
        float IStatCalculatorService.GetAccuracyStageMultiplier(int stage)
        {
            stage = Math.Max(CoreConstants.MinStatStage, Math.Min(CoreConstants.MaxStatStage, stage));
        ...
        /// Formula: Level^3
        /// </summary>
        int IStatCalculatorService.GetExpForLevel(int level)
        {
            CoreValidators.ValidateLevel(level);
        ...
        /// </summary>
        int IStatCalculatorService.GetExpToNextLevel(int currentLevel)
        {
            if (currentLevel < 1 || currentLevel >= 100)
                return 0;

            return ((IStatCalculatorService)this).GetExpForLevel(currentLevel + 1) - ((IStatCalculatorService)this).GetExpForLevel(currentLevel);
        }

        /// <summary>
        /// Calculates what level a Pokemon should be at given total experience.
        /// </summary>
        int IStatCalculatorService.GetLevelForExp(int totalExp)
        {
            if (totalExp < 0)
            ...
            {
                if (totalExp >= ((IStatCalculatorService)this).GetExpForLevel(level))
                    return level;
            }
        ...
        {
            return ((StatCalculatorService)_defaultInstance).CalculateHPInternal(baseHP, level, CoreConstants.DefaultIV, CoreConstants.DefaultEV);
        }
        ...
        {
            return ((StatCalculatorService)_defaultInstance).CalculateHPInternal(baseHP, level, iv, ev);
        }
        ...
        {
            return ((StatCalculatorService)_defaultInstance).CalculateStatInternal(baseStat, level, nature, stat, CoreConstants.DefaultIV, CoreConstants.DefaultEV);
        }
        ...
        {
            return ((StatCalculatorService)_defaultInstance).CalculateStatInternal(baseStat, level, nature, stat, iv, ev);
        }
        ...
        {
            return ((IStatCalculatorService)_defaultInstance).GetStageMultiplier(stage);
        }
        ...
        {
            return ((IStatCalculatorService)_defaultInstance).GetEffectiveStat(calculatedStat, stage);
        }
        ...
        {
            return ((IStatCalculatorService)_defaultInstance).GetAccuracyStageMultiplier(stage);
        }
        ...
        {
            return ((IStatCalculatorService)_defaultInstance).GetExpForLevel(level);
        }
        ...
        {
            return ((IStatCalculatorService)_defaultInstance).GetExpToNextLevel(currentLevel);
        }
        ...
        {
            return ((IStatCalculatorService)_defaultInstance).GetLevelForExp(totalExp);
        }
