...
{
    /// <summary>
    /// Verificador de semi-invulnerabilidad.
    ...
    /// </remarks>
    public class SemiInvulnerableChecker
    {
        private readonly IBattleMessageFormatter _messageFormatter;

        /// <summary>
        /// Crea una nueva instancia del verificador de semi-invulnerabilidad.
        /// </summary>
        /// <param name="messageFormatter">El formateador de mensajes. Si es null, crea uno por defecto.</param>
        public SemiInvulnerableChecker(IBattleMessageFormatter messageFormatter = null)
        {
