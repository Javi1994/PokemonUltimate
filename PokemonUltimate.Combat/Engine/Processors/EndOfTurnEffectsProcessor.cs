...
namespace PokemonUltimate.Combat.Engine.Processors
{
    ...
    public class EndOfTurnEffectsProcessor : IActionGeneratingPhaseProcessor
    {
        ...
        private readonly AccumulativeEffectTracker _accumulativeEffectTracker;
        ...
        public EndOfTurnEffectsProcessor(
            ...
            AccumulativeEffectTracker accumulativeEffectTracker = null)
        {
            ...
            _accumulativeEffectTracker = accumulativeEffectTracker ?? new AccumulativeEffectTracker();
        }
