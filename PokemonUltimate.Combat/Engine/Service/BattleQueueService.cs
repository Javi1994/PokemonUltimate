    ...
    public class BattleQueueService
    {
        ...
        public async Task ProcessQueue(BattleField field, IBattleView view)
        {
            ...
            while (_queue.Count > 0)
            {
                ...
                // Phase 2: Raise ActionExecuted event (for statistics and logging)
                BattleEventManager.RaiseActionExecuted(action, field, reactions ?? Enumerable.Empty<BattleAction>());
