...
{
    /// <summary>
    /// Handler para ejecución de movimientos.
    ...
    /// </remarks>
    public class MoveExecutionHandler : ICheckerHandler
    {
        private readonly IRandomProvider _randomProvider;
        private readonly IBattleMessageFormatter _messageFormatter;

        /// <summary>
        /// Crea una nueva instancia del handler de ejecución de movimientos.
        /// </summary>
        ...
        public MoveExecutionHandler(IRandomProvider randomProvider = null, IBattleMessageFormatter messageFormatter = null)
        {
