...
{
    /// <summary>
    /// Handler para protección de movimientos.
    ...
    /// </remarks>
    public class ProtectionHandler : ICheckerHandler
    {
        private readonly Infrastructure.Messages.Definition.IBattleMessageFormatter _messageFormatter;

        /// <summary>
        /// Crea una nueva instancia del handler de protección.
        /// </summary>
        /// <param name="messageFormatter">El formateador de mensajes. Si es null, crea uno por defecto.</param>
        public ProtectionHandler(Infrastructure.Messages.Definition.IBattleMessageFormatter messageFormatter = null)
        {
