...
{
    /// <summary>
    /// Handler para verificación de aplicación de condiciones de campo (Weather, Terrain, Side Conditions).
    ...
    /// </remarks>
    public class FieldConditionApplicationHandler : IApplicationHandler
    {
        /// <summary>
