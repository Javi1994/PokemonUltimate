...
- **[1.16: Registry System](../1.16-registry-system/)** - Uses IIdentifiable for generic registries

## Documentation

- **[Parent Architecture](../architecture.md#113-interfaces-base)** - Technical specification
