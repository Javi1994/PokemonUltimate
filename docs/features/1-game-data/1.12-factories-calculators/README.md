...
Static class with nature modifier tables:
- `GetStatMultiplier()` - Get nature multiplier for stat
- `GetIncreasedStat()` / `GetDecreasedStat()` - Nature stat modifiers

## Related Sub-Features

- **[1.1: Pokemon Data](../1.1-pokemon-data/)** - Creates Pokemon instances
- **[1.10: Enums & Constants](../1.10-enums-constants/)** - Uses Stat, Nature enums

## Documentation

- **[Parent Architecture](../architecture.md#112-factories--calculators)** - Technical specification
