# Sub-Feature 1.11: Builders - Architecture
...
- **[1.6: Field Conditions Data](../1.6-field-conditions-data/)** - Uses WeatherBuilder, TerrainBuilder, HazardBuilder, SideConditionBuilder, FieldEffectBuilder
- **[1.7: Evolution System](../1.7-evolution-system/)** - Uses EvolutionBuilder, LearnsetBuilder
