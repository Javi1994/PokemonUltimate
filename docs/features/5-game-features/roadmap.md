# Feature 5: Game Features - Roadmap
...
- **[5.1 Architecture](5.1-post-battle-rewards/architecture.md)** - Post-battle system specification
...
- **[Feature 3: Content Expansion](../3-content-expansion/roadmap.md)** - Content expansion roadmap
