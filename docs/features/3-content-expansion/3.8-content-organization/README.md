# Sub-Feature 3.8: Content Organization

> Catalog organization and maintenance.

**Sub-Feature Number**: 3.8  
...
- **[3.5: Status Effect Expansion](../3.5-status-effect-expansion/)** - Organizes Status Effects in catalog
- **[3.6: Field Conditions Expansion](../3.6-field-conditions-expansion/)** - Organizes Field Conditions in catalogs
