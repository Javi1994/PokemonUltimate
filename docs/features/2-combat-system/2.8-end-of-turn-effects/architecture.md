# Sub-Feature 2.8: End-of-Turn Effects - Architecture

> Technical specification of Status damage and effects processing.
...
- **[Sub-Feature README](README.md)** - Overview of End-of-Turn Effects
...
- **[Sub-Feature 2.5: Combat Actions](../2.5-combat-actions/architecture.md)** - Status actions create end-of-turn effects
- **[Sub-Feature 2.6: Combat Engine](../2.6-combat-engine/)** - Engine processes end-of-turn effects
- **[Sub-Feature 2.9: Abilities & Items](../2.9-abilities-items/architecture.md)** - Abilities/items trigger end-of-turn effects
