...
-   **Pipeline Steps**: 11 steps (BaseDamageStep, CriticalHitStep, RandomFactorStep, StabStep, AttackerAbilityStep, AttackerItemStep, WeatherStep, TerrainStep, ScreenStep, TypeEffectivenessStep, BurnStep)
