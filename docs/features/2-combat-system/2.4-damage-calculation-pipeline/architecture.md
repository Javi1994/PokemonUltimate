# Sub-Feature 2.4: Damage Calculation Pipeline - Architecture

> Complete technical specification of the modular damage calculation pipeline.
...
- **[Sub-Feature README](README.md)** - Overview of Damage Calculation Pipeline
