...
-   **Action Types**: 13 total (UseMoveAction, DamageAction, HealAction, ApplyStatusAction, FaintAction, StatChangeAction, SetWeatherAction, SetTerrainAction, SetSideConditionAction, SwitchAction, MessageAction, ContactDamageAction, BattleAction base)
