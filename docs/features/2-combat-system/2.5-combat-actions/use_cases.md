# Sub-Feature 2.5: Combat Actions - Use Cases

> Comprehensive list of ALL use cases that combat actions must handle.

**Sub-Feature Number**: 2.5  
**Parent Feature**: Feature 2: Combat System  
**See**: [`../../features_master_list.md`](../../features_master_list.md) for feature numbering standards.

**Purpose**: Validate implementation coverage before marking actions as complete.  
...
- **[Parent Use Cases](../../use_cases.md)** - Overall combat system use cases
- **[Roadmap](../../roadmap.md#phase-25-combat-actions)** - Implementation status
