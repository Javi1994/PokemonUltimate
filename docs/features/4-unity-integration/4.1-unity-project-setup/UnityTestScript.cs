// Unity Test Script for PokemonUltimate DLL Integration
// Place this file in: Assets/Scripts/PokemonTest.cs
...
public class PokemonTest : MonoBehaviour
{
    ...
    private void TestCreatePokemon()
    {
        ...
        try
        {
            ...
            Debug.Log($"✓ Successfully created {pikachu.Name} (Level {pikachu.Level})");
        }
    ...
    private void TestPokemonMoves()
    {
        ...
        try
        {
            ...
            if (pikachu.Moves.Count > 0)
            {
                ...
                {
                    Debug.Log($"  - {move.Name} (PP: {move.CurrentPP}/{move.MaxPP})");
                }
            }
            else
            {
