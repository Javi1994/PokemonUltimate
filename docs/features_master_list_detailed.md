...
**Status**: ✅ Complete  
**Description**: Modular damage calculation (includes stat/damage modifiers)  
**Dependencies**: 1, 2.1

#### 2.5: Combat Actions
**Folder**: `docs/features/2-combat-system/2.5-combat-actions/`  
**Status**: ✅ Complete  
**Description**: UseMove, Damage, Status, Heal, Switch, Faint  
**Dependencies**: 2.1

#### 2.6: Combat Engine
**Folder**: `docs/features/2-combat-system/2.6-combat-engine/`  
**Status**: ✅ Complete  
**Description**: Battle loop, turn execution, outcome detection  
**Dependencies**: 2.1, 2.2, 2.3, 2.4, 2.5

#### 2.7: Integration
**Folder**: `docs/features/2-combat-system/2.7-integration/`  
**Status**: ✅ Complete  
**Description**: AI providers, Player input, Full battles  
**Dependencies**: 2.6
...
**Status**: ✅ Complete  
**Description**: Event-driven system, triggers  
**Dependencies**: 2.6
...
**Status**: ⏳ Planned  
**Description**: Multi-hit, charging moves  
**Dependencies**: 2.5
