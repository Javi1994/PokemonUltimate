...
- [ ] Compliance with docs/ai/guidelines/project_guidelines.md
...
Check against:
1. docs/ai/guidelines/project_guidelines.md - All 24 rules
2. docs/ai/anti-patterns.md - Common mistakes
...
Reference: docs/ai/GETTING_STARTED.md (Project Structure section)
```
