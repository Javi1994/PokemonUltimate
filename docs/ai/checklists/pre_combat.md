...
### From `docs/features/2-combat-system/architecture.md`
...
### From `docs/features/2-combat-system/2.4-damage-calculation-pipeline/architecture.md`
...
### From `docs/features/2-combat-system/2.3-turn-order-resolution/architecture.md`
