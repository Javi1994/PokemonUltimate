...
| Document | Purpose |
|----------|---------|
| `docs/unity_integration.md` | Technical integration guide |
| `docs/architecture/ui_presentation_system.md` | UI system specification |
| `docs/architecture/player_ai_spec.md` | Input system specification |
...
| Date | Phase | Notes |
|------|-------|-------|
| [Current Date] | 4.1-4.8 | Initial Unity integration roadmap created. |
